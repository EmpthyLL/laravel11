<x-layout>
  ...
  <main>
    <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
        <div class="border border-sky-200 shadow-blue-100 hover:shadow-blue-200 transition-shadow shadow-lg hover:shadow-xl p-4 rounded-lg flex gap-4 bg-blue-100 items-center min-w-[400px] max-w-[500px]">
            <img src="{{ asset('img/photo_10.jpg') }}" width="200px" class="rounded-full p-1 border-2 border-sky-200 shadow-lg bg-sky-100" alt="Profile Picture">
          <div>
