<x-layout>
  ...
  <main>
    <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
        <div class="border-2 border-gray-300  transition-shadow shadow-lg hover:shadow-xl p-4 rounded-lg flex gap-4 bg-slate-100 items-center min-w-[400px] max-w-[500px]">
